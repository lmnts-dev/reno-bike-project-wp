...
<svg class="squiggle-vertical <?php echo 'clr-' . $squiggle['color'] ?> <?php echo 'align-' . $squiggle['center'] ?>" width="8px" height="<?php echo $height ?>px" viewBox="0 0 8 <?php echo $height ?>">
