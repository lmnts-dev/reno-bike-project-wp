...
<p>
	<a href="<?php echo get_post_comments_feed_link($post->ID); ?>">
...
<?php if ($comments) { ?>
	<ol id="commentlist">
		...
		<li id="comment-<?php comment_ID() ?>">
			...
			<p>
				<cite>
					<?php comment_type('Comment', 'Trackback', 'Pingback'); ?> by <?php comment_author_link() ?> &#8212; 
...
<strong><a href="javascript:window.close()">Close this window.</a></strong></div>
...
<p class="credit">
	<?php timer_stop(1); ?> 
	<cite>
		Powered by <a href="http://mu.wordpress.org/" title="Powered by WordPress, state-of-the-art semantic personal publishing platform"><strong>WordPress</strong></a>
	</cite>
</p>
