    ...
    <div class="home-hero-inner">
      <div class="col-info">
        <div class="col-info-top">
          ...
          <a href="<?php echo get_sub_field('call_to_action')['url']; ?>" class="btn btn-arrow" <?php echo get_sub_field('call_to_action')['link_type'] == 'external' ? ' target="_blank" ' : ( get_sub_field('call_to_action')['link_type'] == 'download' ? 'download' : ''  ) ?>>
