...
<svg class="squiggle-horizontal <?php echo 'clr-' . $squiggle['color'] ?> <?php echo 'align-' . $squiggle['align'] ?>" width="<?php echo $width ?>px" height="8px" viewBox="0 0 <?php echo $width ?> 8">
