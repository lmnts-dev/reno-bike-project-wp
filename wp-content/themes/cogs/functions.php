...
<?php
   ...
   //add_filter( 'rewrite_rules_array', 'disable_embeds_rewrites' );
	...
	function load_theme_scripts() {
	    if(!is_admin()) {
            //wp_enqueue_script('Plugins', get_template_directory_uri() . '/js/plugins.min.js?v=31', '', '', true );
            wp_enqueue_script('Main', get_template_directory_uri() . '/js/main.min.js?v=36', '', '', true );
						wp_enqueue_style( 'danny-forster-architecture', get_template_directory_uri() . '/css/main.css?v=41');
						wp_enqueue_style( 'lmnts', get_template_directory_uri() . '/sass/lmnts.css');
			...
			wp_localize_script( 'Main', 'dannyforster', $args );
	    }
	}
