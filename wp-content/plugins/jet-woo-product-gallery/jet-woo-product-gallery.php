 ...
 * Plugin URI:  https://crocoblock.com/woocommerce/jetproductgallery/
	...
	class Jet_Woo_Product_Gallery {
		...
		public function init() {
			...
			if ( is_admin() ) {
				...
				require $this->plugin_path( 'includes/updater/class-jet-woo-product-gallery-plugin-update.php' );

				new Jet_Woo_Product_Gallery_Plugin_Update( array(
					'version' => $this->get_version(),
					'slug'    => 'jet-woo-product-gallery',
				) );

				// Init plugin changelog
				require $this->plugin_path( 'includes/updater/class-jet-woo-product-gallery-plugin-changelog.php' );

				jet_woo_product_gallery_plugin_changelog()->init( array(
					'name'     => 'JetProductGallery For Elementor',
					'slug'     => 'jet-woo-product-gallery',
					'version'  => $this->get_version(),
					'author'   => '<a href="https://zemez.io/wordpress/">Zemez</a>',
					'homepage' => 'https://crocoblock.com/woocommerce/jetproductgallery/',
					'banners'  => array(
